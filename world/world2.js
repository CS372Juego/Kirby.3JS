...
const blockDimensionsList = [
    ...
    { width: 10, height: 20, depth: LAND_WIDTH, x: LAND_BEGIN_X + 30, y: 5, z: 0 },
    { width: 20, height: 60, depth: LAND_WIDTH, x: LAND_BEGIN_X + 65, y: 40, z: 0 },
    { width: 10, height: 3, depth: LAND_WIDTH, x: LAND_BEGIN_X + 90, y: 14, z: 0 },
    { width: 10, height: 3, depth: LAND_WIDTH, x: LAND_BEGIN_X + 80, y: 24, z: 0 },
    { width: 10, height: 3, depth: LAND_WIDTH, x: LAND_BEGIN_X + 90, y: 34, z: 0 },
    { width: 10, height: 3, depth: LAND_WIDTH, x: LAND_BEGIN_X + 80, y: 44, z: 0 },
    { width: 10, height: 3, depth: LAND_WIDTH, x: LAND_BEGIN_X + 90, y: 54, z: 0 },
    { width: 10, height: 3, depth: LAND_WIDTH, x: LAND_BEGIN_X + 120, y: 70, z: 0 },
    { width: 50, height: 60, depth: LAND_WIDTH, x: LAND_BEGIN_X + 120, y: 30, z: 0 },
    { width: 10, height: 3, depth: LAND_WIDTH, x: LAND_BEGIN_X + 165, y: 54, z: 0 },
