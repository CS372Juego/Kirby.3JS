...
export async function loadTreeModel() {
    ...
    await treeModel.load('src/assets/model/tree.glb', Math.PI/2);
...
export class StarBox {
    constructor() {
        ...
        const texture = textureLoader.load('src/assets/texture/starbox.png');
...
export async function loadStarModel() {
    return new Promise((resolve, reject) => {
        ...
        mtlLoader.load('src/assets/model/star/WarpStar.mtl', (materials) => {
            materials.preload();
            const objLoader = new OBJLoader();
            objLoader.setMaterials(materials);
            objLoader.load('src/assets/model/star/WarpStar.obj', (obj) => {
...
function loadGordoModel() {
    return new Promise((resolve, reject) => {
        const mtlLoader = new MTLLoader();
        mtlLoader.load('src/assets/model/gordo/DolGordo.mtl', (materials) => {
            materials.preload();
            const objLoader = new OBJLoader();
            objLoader.setMaterials(materials);
            objLoader.load('src/assets/model/gordo/DolGordo.obj', (obj) => {
                obj.traverse(function (child) {
                    if (child.isMesh) {
                        child.castShadow = true;
                        child.receiveShadow = true;
